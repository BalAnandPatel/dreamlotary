...
// create ticket purchase history
 ...
 $history_data = array("userId"=>$userId, "ticketAmount"=>$ticketAmount, "lotaryAmount"=>$lotaryAmount, "lotaryNum"=>$lotaryNum, "status"=>$status, "createdOn"=>$createdOn, "createdBy"=>$createdBy);
