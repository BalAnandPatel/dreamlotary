          ...
          <form action="action/ticket_entry_post.php" method="post">
            <div class="row">
              <div class="col-md-6">
               ...
               <div class="col-md-6">
                  <div class="form-group">
                    <label for="name">Lotary Amount*</label>
                    <input type="number" class="form-control" name="lotaryAmount" id="exampleFormControlInput1" placeholder="Lotary Amount" autocomplete="off" required>
                  </div>
              </div>
